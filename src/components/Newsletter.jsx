        ...
        <DialogActions sx={{ p: 2, borderTop: 1, borderColor: isDarkMode ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.1)' }}>
          ...
          {newsletterType === 'announcement' && (
            <LoadingButton
              ...
              disabled={!announcementForm.title || !announcementForm.subject || !announcementForm.announcement || sending}
              sx={{
                color: '#fff !important',
                background: isDarkMode
                  ? 'linear-gradient(135deg, #d9764a 0%, #de7527 100%)'
          ...
          {newsletterType === 'blog' && (
            <LoadingButton
              ...
              disabled={!blogForm.subject || selectedBlogs.length === 0 || sending}
              sx={{
                color: '#fff !important',
                background: isDarkMode
                  ? 'linear-gradient(135deg, #d9764a 0%, #de7527 100%)'
            ...
            >
              {sending ? 'Scheduling...' : 'Schedule Newsletter'}
            </LoadingButton>
          )}
        </DialogActions>
      </Dialog>
